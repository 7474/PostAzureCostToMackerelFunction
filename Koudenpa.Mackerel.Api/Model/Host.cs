...
namespace Koudenpa.Mackerel.Api.Model
{
    ...
    public partial class Host :  IEquatable<Host>, IValidatableObject
    {
        ...
        public Host(decimal createdAt = default(decimal), string id = default(string), string name = default(string), string displayName = default(string), string customIdentifier = default(string), Object meta = default(Object), List<Object> interfaces = default(List<Object>), string type = default(string), string status = default(string), string memo = default(string), bool isRetired = default(bool), decimal retiredAt = default(decimal), Object roles = default(Object))
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for Host and cannot be null");;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Host and cannot be null");;
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for Host and cannot be null");;
            // to ensure "interfaces" is required (not null)
            this.Interfaces = interfaces ?? throw new ArgumentNullException("interfaces is a required property for Host and cannot be null");;
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for Host and cannot be null");;
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for Host and cannot be null");;
            // to ensure "memo" is required (not null)
            this.Memo = memo ?? throw new ArgumentNullException("memo is a required property for Host and cannot be null");;
            this.IsRetired = isRetired;
            this.RetiredAt = retiredAt;
            // to ensure "roles" is required (not null)
            this.Roles = roles ?? throw new ArgumentNullException("roles is a required property for Host and cannot be null");;
